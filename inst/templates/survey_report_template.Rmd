---
title: "Health Facility Assessment - Data Analysis Report"
author: "John Doe"
date: "`r Sys.Date()`"
output: 
  html_document:
...
/* TOC Sidebar */
.tocify-wrapper {
  width: 280px !important;     /* Adjust width of left menu */
...
/* Content area */
.toc-content {
  max-width: 1500px !important;   /* adjust overall text width */
  margin-left: 300px !important;  /* push content right so it doesn't overlap TOC */
