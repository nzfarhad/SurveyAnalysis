...
#' \describe{
#'   \item{\code{\link{generate_rmd_template}}}{Generate R Markdown templates for HTML and Word survey reports}
#' }
#'
...
#'   \item R Markdown template generation for HTML and Word report creation
#' }
#'
#' @examples
#' \dontrun{
