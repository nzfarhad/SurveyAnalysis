#' Enhanced Min/Max Analysis with Automatic Disaggregation
#'
#' Enhanced statistical analysis functions for calculating minimum and maximum values with automatic disaggregation handling.
...
# Enhanced Min calculation
#' @rdname analyze_minmax
...
#' @return A data frame with minimum value and metadata
#' @examples
#' # Create sample data
...
#' print(min_by_region)
#' @export
analyze_min <- function(df, ques, disag = NULL, level = NULL, show_view = FALSE, wide_format = FALSE, dt_table = FALSE, create_plot = FALSE, max_categories = 10, max_label_length = 12, font_sizes = list(plot_title = 12, legend_title = 10, legend_text = 10, geom_text = 3, axis_title = 10)) {
...
#' print(max_by_region)
#' @export
analyze_max <- function(df, ques, disag = NULL, level = NULL, show_view = FALSE, wide_format = FALSE, dt_table = FALSE, create_plot = FALSE, max_categories = 10, max_label_length = 12, font_sizes = list(plot_title = 12, legend_title = 10, legend_text = 10, geom_text = 3, axis_title = 10)) {
